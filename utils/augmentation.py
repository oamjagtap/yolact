...
class RandomSampleCrop(object):
    ...
    def random_choice(self):
        # Choose a random index from the range of sample_options
        index = random.randint(0, len(self.sample_options) - 1)
        return self.sample_options[index]
